...
public class ProductFactory {
    ...
    {
        type2clazzName.put("a", "me.tanpp.common.designpattern.factory.v1.ProductA");
    }
     ...
     * 需要在resource下的META-INF->services->me.tanpp.common.designpattern.factory.Product文件中定义好路径*/
