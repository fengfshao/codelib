package com.berry.commons.json;
...
/*        public String getSomething() {
    ...
    public static void highApiParse() throws Exception {
        String json1 = toJson(Collections.singletonMap("personal", Collections.singletonMap("name", "wang")));
    ...
    public static void AutoTypeMapping() throws Exception {
        ...
        // array -> ArrayList
        List<Object> array = (List<Object>) mapper.readValue(toJson(Arrays.asList("aa", "bb", "cc")), Object.class);
    ...
    public static void ParseBeanByUntidy() throws Exception {
        ...
        // 反序列化时可以容忍字段缺失
        String json1 = toJson(Collections.singletonMap("age", 3));
        ...
        String json2 = toJson(fieldsValues);
