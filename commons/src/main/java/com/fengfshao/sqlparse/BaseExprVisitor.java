...
import com.fengfshao.sqlparse.udf.UdfCache;
 ...
 * Description:
 */
public class BaseExprVisitor extends ExprNotSupVisitor {

    protected Map<String,Object> fieldValues;
    protected Object result;
    protected List<Object> resultLists;
    ...
    public void visit(Column var1) {
        ...
        try {
            ...
            throw new UnsupportedOperationException("Column not supported! ColName:" + colName,e);
        }
    }
